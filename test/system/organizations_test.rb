...
class OrganizationsTest < ApplicationSystemTestCase
  ...
  test "creating a Organization" do
    ...
    fill_in "Gitlab folder", with: @organization.gitlab_folder_id
    fill_in "Gitlab token", with: @organization.gitlab_token
    fill_in "Gitlab url", with: @organization.gitlab_url
